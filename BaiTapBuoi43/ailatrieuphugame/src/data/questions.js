const QUESTION_DATABASE = [
  ...
  {
    question:
      "Tác phẩm văn học 'Truyện Kiều' do đại thi hào nào sáng tác?",
  ...
  {
    question:
      "Tỉnh nào có diện tích tự nhiên lớn nhất Việt Nam hiện nay?",
  ...
  {
    question:
      "Bức tranh nổi tiếng 'Mona Lisa' là kiệt tác của danh họa nào?",
    answers: [
      "Pablo Picasso",
      "Vincent van Gogh",
      "Leonardo da Vinci",
