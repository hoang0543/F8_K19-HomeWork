...
export default function EmployerRegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.international_name.trim()) {
      newErrors.international_name =
        "Vui lòng nhập tên quốc tế";
    }
  ...
  const handleRegister = (event) => {
    ...
    const payload = {
      ...
      international_name: formData.international_name,
    ...
    console.log("Employer register payload:", payload);
            ...
            <Box className={styles.formGrid}>
              ...
              <Box>
                ...
                <TextField
                  ...
                  helperText={errors.international_name}
                  className={styles.input}
                />
              </Box>
